    ...
    return {
        ...
        initPieCharts: function() {
            ...
            if ($('#donut').length !== 0) {
                ...
                data = [
                    {label:"0-13 سال",data:3},
                    {label:"14-23 سال",data:5},
                    {label:"24-33 سال",data:11},
                    {label:"34-50 سال",data:5},
                ]
                $.plot($("#donut"), data, {
                    series: {
                        pie: {
            ...
            if ($('#interactive').length !== 0) {
                ...
                data = [
                    {label:"api level 18 jelly bean",data:3},
                    {label:"api level 19 kitkat",data:4},
                    {label:"api level 21-22 lollipop",data:3},
                    {label:"api level 23 marshmallow",data:6},
                    {label:"api level 24-25 nougat",data:4},
                    {label:"api level 26-27 oreo",data:5},
                    {label:"api level 28 pie",data:0},
                    {label:"api level 29 Q",data:0}
                ]
