    ...
    return {
        init: function () {
            r(), $(".login-bg").backstretch([
                "/public/theme/assets/pages/img/login/bg4.png",
                "/public/theme/assets/pages/img/login/bg2.png",
                "/public/theme/assets/pages/img/login/bg3.png",
                "/public/theme/assets/pages/img/login/bg1.png"], {
                fade: 1e3,
                duration: 8e3
            }), $(".forget-form").hide()
        }
