        ...
        <div class="row">
            ...
            <div class="col-md-4 col-6 mb-30">
                <div class="text-center">
                    ...
                    <h7>رفع شدن ایراد های گزارش شده پس از بازگذاری مجدد بررسی می شود</h7>
                </div>
            </div>
            <div class="col-md-4 col-6 mb-30">
                <div class="text-center">
...
-->
        ...
        <div class="col-md-6 text-right">
            ...
            <p>برای اینکه آلفادین را بهتر بشناسید فیلم را ببینید</p>
            <h7>آلفادین بهترین روش کسب درآمد آنلاین است در منزل بنشینید و با آلفادین کسب درآمد کنید</h7>
        </div>
    </div>
</section>
<section>
    <div class="container">
        ...
        <article class="row">
            ...
            <div class="col-md-6 text-right">
                ...
                <h7>آلفادین با اتکا بر علوم روز و داشتن تیم های متخصص برنامه نویسی و مشاوران
                    یکی از بهترین راهنمایان شما در جهت پیشبرد اهداف است ، شما با اعتماد بر آلفادین می توانید
