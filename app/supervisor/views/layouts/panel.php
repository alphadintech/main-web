...
use supervisor\assets\PanelAsset;
...
<?php $this->beginPage() ?>
    ...
    <body class="IRANSansLight page-header-fixed page-sidebar-closed-hide-logo page-content-white page-md">
    <?php $this->beginBody() ?>
                ...
                <ul class="nav navbar-nav pull-right">
                            ...
                            <li>
                                <ul class="dropdown-menu-list scroller" style="height: 275px;"
                                    ...
                                    <li>
                                        <a href="#">
                                                <span class="photo">
                                                    <img src="../theme/assets/layouts/layout/img/avatar2.jpg"
                                    ...
                                    <li>
                                        <a href="#">
                                                <span class="photo">
                                                    <img src="../theme/assets/layouts/layout/img/avatar3.jpg"
                                                         class="img-circle" alt=""> </span>
                                            <span class="subject">
                                    ...
                                    <li>
                                        <a href="#">
                                                <span class="photo">
                                                    <img src="../theme/assets/layouts/layout/img/avatar1.jpg"
                                                         class="img-circle" alt=""> </span>
                                            <span class="subject">
                    ...
                    <li class="dropdown dropdown-user">
                        ...
                        <ul class="dropdown-menu dropdown-menu-default">
                            ...
                            <li>
                                <a href="<?= Yii::$app->urlManagerFrontend->createUrl('logout') ?>"><i
                                            class="icon-key"></i> خروج </a>
        ...
        <div class="page-sidebar-wrapper">
            <div class="page-sidebar navbar-collapse collapse">
                <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
                    ...
                    <li class="heading">
                        <h3 class="uppercase">دسترسی های سرپرست</h3>
                    </li>
                    <li class="nav-item  active open">
                        <a href="../supervisor/dashboard" class="nav-link nav-toggle">
                            <i class="icon-home"></i>
                    ...
                    <li class="nav-item">
                        <a href="../supervisor/project" class="nav-link nav-toggle">
                            <i class="icon-user"></i>
                    ...
                    <li class="nav-item">
                        <a href="../supervisor/testers" class="nav-link nav-toggle">
                            <i class="icon-bar-chart"></i>
                            <span class="title">آزمونگران</span>
                            <span class="selected"></span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="../supervisor/invitation" class="nav-link nav-toggle">
                            <i class="icon-globe"></i>
                            <span class="title">دعوتنامه‌ها</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="../supervisor/test" class="nav-link nav-toggle">
                            <i class="icon-briefcase"></i>
                            <span class="title">آزمون‌ها</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="../supervisor/school" class="nav-link nav-toggle">
